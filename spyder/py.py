# -*- coding: utf-8 -*-
"""
Created on Sun Nov 28 17:26:59 2021
...
class Weather():
 ...
 # （1）获取中央气象台天气图数据     
    ...
    def __all_time(self):
        ...
        today = datetime.datetime(2021, 11, 27)
        n = 1
        t_list = [today]
        while n <5:
                ...
                for p in patt:
                    ...
                    try:         
                        if not os.path.exists(file_name):
                            ...
                            url = 'http://image.nmc.cn/product/%s/WESA/SEVP_NMC_WESA_SFER_%s_ACWP_%s_P9_%s%s0000000.jpg'%(self.time1,p,h,self.time2,t)
